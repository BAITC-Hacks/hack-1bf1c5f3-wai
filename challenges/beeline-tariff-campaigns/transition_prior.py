...
Adapted from teammate commit e2b864d for offline integration experiments.
The active submission does not import this model: neither tested integration
earned adoption on held-out synthetic scenarios. Frozen candidates retain their
own copies; this reusable module supports the experiment adapters and tests.
"""
